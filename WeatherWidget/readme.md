This weather widget successfully fetches the weather data from openWeather API and updates the weather according to your search location. The weather types focused on 
